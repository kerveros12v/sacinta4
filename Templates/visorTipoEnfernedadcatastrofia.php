...
<head>
  <meta charset="utf-8">
  <title>Tipo Enfermedad Catastrofica</title>
  ...
  <script type="text/javascript" src="../js/ajaxstipoenfermedadcatastrofica.js"></script>
</head>
...
<body>
  ...
  <table class="ui-widget ui-widget-content" title="Perfiles Registradas Actualmente:">
    <tr class="ui-widget-header">
      <th></th>
      <th>Codigo</th>
      <th>Tipo Enfermedad Catastrofica</th>
      <th></th>

    </tr>
    <tbody id="contenedorTec">
    </tbody>
  </table>
</body>
