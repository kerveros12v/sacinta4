...
<head>
  <meta charset="utf-8">
  <title>Ingreso con Concurso de Meritos</title>
  ...
  <script type="text/javascript" src="../js/ajaxsingresoconconcursomeritorio.js"></script>
</head>
...
<body>
  ...
  <table class="ui-widget ui-widget-content" title="Perfiles Registradas Actualmente:">
    <tr class="ui-widget-header">
      <th></th>
      <th>Codigo</th>
      <th>Ingreso con Concurso de Meritos</th>
      <th></th>

    </tr>
    <tbody id="contenedorconcursomeritos">
    </tbody>
  </table>
</body>
