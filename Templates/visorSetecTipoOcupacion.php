...
<head>
  <meta charset="utf-8">
  <title>Tipo Ocupacion de Setec</title>
  ...
  <script type="text/javascript" src="../js/ajaxsSetecTipoOcupacion.js"></script>
</head>
...
<body>
  ...
  <table class="ui-widget ui-widget-content" title="Perfiles Registradas Actualmente:">
    <tr class="ui-widget-header">
      ...
      <th>Codigo</th>
      <th>Detalle del Tipo Ocupacion</th>
      <th></th>
    </tr>
    <tbody id="setecocupacion">
    </tbody>
  </table>
</body>
