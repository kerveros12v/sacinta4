...
<head>
  ...
  <title>Formacion Artesanal</title>
  ...
  <script type="text/javascript" src="../js/ajaxsformacionartesanal.js"></script>
</head>
...
<body>
  ...
  <table class="ui-widget ui-widget-content" title="Perfiles Registradas Actualmente:">
    <tr class="ui-widget-header">
      <th></th>
      <th>Codigo</th>
      <th>Formacion Artesanal</th>
      <th></th>
    </tr>
    <tbody id="contenedorformacion">
    </tbody>
  </table>
</body>
