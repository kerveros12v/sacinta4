...
<head>
  <meta charset="utf-8">
  <title>Pueblo Nacionalidad</title>
  ...
  <script type="text/javascript" src="../js/ajaxspueblonacionalidad.js"></script>
</head>
...
<body>
  ...
  <table class="ui-widget ui-widget-content" title="Perfiles Registradas Actualmente:">
    <tr class="ui-widget-header">
      <th></th>
      <th>CODIGO</th>
      <th>PUEBLO NACIONALIDAD</th>
      <th></th>

    </tr>
    <tbody id="contenedorpueblonacionalidad">
    </tbody>
  </table>
</body>
