...
<head>
  <meta charset="utf-8">
  <title>Estado de Ocupacion</title>
  ...
  <script type="text/javascript" src="../js/ajaxsSetecEstadoOcupacional.js"></script>
</head>
...
<body>
  ...
  <table class="ui-widget ui-widget-content" title="Perfiles Registradas Actualmente:">
    <tr class="ui-widget-header">
      <th>Codigo</th>
      <th>Detalle del Estado de Ocupacion</th>
      <th></th>
    </tr>
    <tbody id="setecestadoOcupacional">
    </tbody>
  </table>
</body>
