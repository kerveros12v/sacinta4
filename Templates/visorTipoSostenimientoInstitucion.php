...
<head>
  <meta charset="utf-8">
  <title>Tipo Sostenimiento</title>
  ...
  <script type="text/javascript" src="../js/ajaxstiposostenimiento.js"></script>
</head>
...
<body>
  ...
  <table class="ui-widget ui-widget-content" title="Perfiles Registradas Actualmente:">
    <tr class="ui-widget-header">
      <th></th>
      <th>Codigo</th>
      <th>Tipo Sostenimiento</th>
      <th></th>

    </tr>
    <tbody id="contenedortiposostenimiento">
    </tbody>
  </table>
</body>
