...
<head>
  <meta charset="utf-8">
  <title>Setec Estado Certificacion</title>
  ...
  <script type="text/javascript" src="../js/ajaxssetecestadocertificacion.js"></script>
...
<body>
  ...
  <table class="ui-widget ui-widget-content" title="Perfiles Registradas Actualmente:">
    <tr class="ui-widget-header">
      <th></th>
      <th>Codigo</th>
      <th>Setec Estado Certificacion</th>
      <th></th>

    </tr>
    <tbody id="contenedorsetecestadocertificacion">
    </tbody>
  </table>
</body>
