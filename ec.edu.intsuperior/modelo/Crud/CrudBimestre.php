...
class CrudBimestres
{
	...
	public function mostrar()
	{
		...
		foreach ($select->fetchAll() as $bimestres) {
			...
			$mybimestres->set_idBimestres($bimestres['idBimestres']);
			$mybimestres->set_bimestre($bimestres['bimestre']);
			$mybimestres->set_bimestrescodigo($bimestres['bimestrescodigo']);
			$mybimestres->set_bimestresOculto($bimestres['bimestresOculto']);
			$mybimestres->set_bimestresAccion($bimestres['bimestresAccion']);
			$mybimestres->set_bimestresfecha($bimestres['bimestresfecha']);
			$mybimestres->set_bimestresuser($bimestres['bimestresuser']);
