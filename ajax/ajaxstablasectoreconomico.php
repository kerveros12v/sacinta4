...
<tr>
    ...
    <td>
        <input type="text" class="camptext3" id="SectorEconomico" name="SectorEconomico"  value=""/>
    </td>
    <td>
...
';
    ...
    <tr>
        ...
        <td>
            <input type="text" class="camptext3" id="SectorEconomico' . $dato->getSectorEconomicoid() . '" name="SectorEconomico' . $dato->getSectorEconomicoid() . '"  value="' . $dato->getSectorEconomico() . '"/>
        </td>
        <td class="unilinea">
