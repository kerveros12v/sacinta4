...
function cargarsectoreconomico($opt)
{
    ...
    foreach ($listsectrabajo as $sectrabajo) {
        if ($opt == $sectrabajo->getSectorEconomicoid()) {
            $lista .= " <option selected='selected' value='" . $sectrabajo->getSectorEconomicoid() . "'>
            <label>
            " . $sectrabajo->getSectoreconomicocodigo() . " - " . ($sectrabajo->getSectorEconomico()) . "
            </label>
            </option>";
        } else {
            $lista .= "<option  value='" . $sectrabajo->getSectorEconomicoid() . "'>
            <label>
            " . $sectrabajo->getSectoreconomicocodigo() . " - " . ($sectrabajo->getSectorEconomico()) . "
            </label>
            </option>";
